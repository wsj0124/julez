        ...
        <div class="o-layout o-layout--small c-gallery">
            <?php foreach (array_slice($gallery->images(), 0, 6) as $image): ?>
                <div class="o-layout__item u-1/2@tablet u-1/3@desktop">
                    <a data-fresco-group="<?php echo $gallery->ID(); ?>" data-fresco-caption="<?php echo $image->caption(); ?>" class="fresco" href="<?php echo $image->url('large'); ?>">
            ...
            <?php foreach (array_slice($gallery->images(), 6) as $i => $image): ?>
                <?php if ($i === 0): ?>
                    <div class="c-load-more">
                        <a class="c-btn c-btn--primary c-btn--ghost fresco" data-fresco-group="<?php echo $gallery->ID(); ?>" data-fresco-caption="<?php echo $image->caption(); ?>" href="<?php echo $image->url('large'); ?>">
                            View full gallery
                ...
                <?php else: ?>
                    <a style="display: none;" data-fresco-group="<?php echo $gallery->ID(); ?>" data-fresco-caption="<?php echo $image->caption(); ?>" class="fresco" href="<?php echo $image->url('large'); ?>"></a>
                <?php endif; ?>
            <?php endforeach; ?>
        <?php endif; ?>
    </div>
